...
\definechangesauthor[name={Leo}, color=blue]{LM}
...
\usepackage[spanish,ruled,vlined]{algorithm2e} % Paquete para algoritmos en español
\SetAlgoNlRelativeSize{0}                     % Tamaño de numeración de línea
\SetAlgoNlRelativeSize{-1}                    % Opcional, ajustar numeración
\SetAlgoCaptionSeparator{.}                   % Separador entre "Algoritmo 1" y título
\SetKwInput{KwIn}{Entrada}                    % Cambia Input a Entrada
\SetKwInput{KwOut}{Salida}                    % Cambia Output a Salida
% Definimos que los nombres de columnas pueden contener código LaTeX
\pgfplotstableset{
    string type, % importante para que lea $...$ como LaTeX
...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Dinámica clásica de bosones interactuantes en 3 pozos}
...
\degree{Licenciado en Física}       % Carrera
